...
GROQ_API_KEY=your_key_here`}
          ...
          <section id="first-steps" className="mb-16">
            ...
            <ol className="space-y-4 list-decimal list-inside">
              <li className="text-[var(--muted)]">Register account at /register</li>
              <li className="text-[var(--muted)]">Login with credentials</li>
              <li className="text-[var(--muted)]">Upload dataset (CSV, XLSX, JSON)</li>
              <li className="text-[var(--muted)]">Configure cleaning pipeline</li>
              <li className="text-[var(--muted)]">Monitor job execution</li>
              <li className="text-[var(--muted)]">Download cleaned results</li>
            </ol>
          </section>
...
{`curl -X POST http://localhost:8000/api/v1/datasets/upload \\
  ...
  -H "Authorization: Bearer <token>"`}
          ...
          <section id="pipelines" className="mb-16">
            ...
            <p className="mb-4 text-[var(--muted)]">Available operations:</p>
            <ul className="space-y-2 list-disc list-inside text-[var(--muted)]">
          ...
          <section id="endpoints" className="mb-16">
            ...
            <div className="space-y-4">
              <div className="border border-black p-4">
                ...
                <p className="text-sm text-[var(--muted)] mt-2">List all datasets</p>
              </div>
              <div className="border border-black p-4">
                <code className="font-mono text-sm">POST /api/v1/pipelines/execute</code>
                <p className="text-sm text-[var(--muted)] mt-2">Execute cleaning pipeline</p>
              </div>
              <div className="border border-black p-4">
                <code className="font-mono text-sm">GET /api/v1/jobs/{`{id}`}</code>
                <p className="text-sm text-[var(--muted)] mt-2">Get job status</p>
              </div>
              <div className="border border-black p-4">
                <code className="font-mono text-sm">POST /api/v1/documents/upload</code>
                <p className="text-sm text-[var(--muted)] mt-2">Upload document</p>
              </div>
              <div className="border border-black p-4">
                <code className="font-mono text-sm">POST /api/v1/queries</code>
                <p className="text-sm text-[var(--muted)] mt-2">Query documents</p>
              </div>
            </div>
          </section>
            ...
            <table className="w-full border border-black">
              ...
              <tbody>
                <tr className="border-b border-black">
                  ...
                  <td className="p-4 text-[var(--muted)]">Bad request</td>
                </tr>
                <tr className="border-b border-black">
                  <td className="p-4 font-mono">401</td>
                  <td className="p-4 text-[var(--muted)]">Unauthorized</td>
                </tr>
                <tr className="border-b border-black">
                  <td className="p-4 font-mono">404</td>
                  <td className="p-4 text-[var(--muted)]">Not found</td>
                </tr>
                <tr className="border-b border-black">
                  <td className="p-4 font-mono">413</td>
                  <td className="p-4 text-[var(--muted)]">File too large</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono">500</td>
                  <td className="p-4 text-[var(--muted)]">Server error</td>
                </tr>
              </tbody>
            </table>
          </section>
