    ...
    <div className="min-h-screen flex flex-col">
      <header className="border-b border-black px-6 py-4">
        <nav className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-8 text-sm">
            ...
            <Link href="http://localhost:5173" className="px-4 py-2 bg-black text-white hover:bg-accent transition-colors">Launch App</Link>
          </div>
        </nav>
      </header>
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <p className="text-2xl mb-8 text-muted">Page not found</p>
          <Link href="/" className="inline-block px-8 py-4 bg-black text-white hover:bg-accent transition-colors">
            Return Home
          </Link>
        </div>
      </main>
